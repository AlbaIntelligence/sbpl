...
PYBIND11_MODULE(_sbpl_module, m) {
    ...
    py::class_<EnvNAVXYTHETALAT_InitParms>(m, "EnvNAVXYTHETALAT_InitParms")
        ...
        .def_readwrite("expansion_angle_lower_limit", &EnvNAVXYTHETALAT_InitParms::expansion_angle_lower_limit)
        .def_readwrite("expansion_angle_upper_limit", &EnvNAVXYTHETALAT_InitParms::expansion_angle_upper_limit)
    ;
